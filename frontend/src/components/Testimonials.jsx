...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      text: "When my father needed urgent blood in Mumbai, BloodLink connected us with donors in under 10 minutes. They literally saved his life!",
      rating: 5,
      bloodType: "AB-",
    },
    {
      ...
      text: "The gamification and leaderboard feature motivates me to donate regularly. I'm proud to be in the top 10 donors in Hyderabad this month!",
      rating: 5,
      bloodType: "B+",
    },
    {
      ...
      text: "Organizing blood donation camps in Delhi has never been easier. BloodLink's platform is intuitive and reaches thousands of potential donors.",
      rating: 5,
      bloodType: "A+",
    },
    {
      ...
      text: "As a doctor at Apollo Hospital, I've seen how BloodLink bridges the gap between blood banks and patients. The verification system is top-notch!",
      rating: 5,
      bloodType: "O-",
    },
    {
      ...
      text: "I was nervous about donating for the first time in Ahmedabad, but BloodLink's guides and supportive community made the experience wonderful!",
      rating: 5,
      bloodType: "A-",
    },
  ];
